...
extension ViewController {
    ...
    func setWeatherUI(weather: OpenMeteoResponse) {
        ...
        myViews().configure(views: &views, weather: weather)
...
class myViews {
    ...
    func configure(views: inout [UIView], weather: OpenMeteoResponse) {
...
class Constraints {
    ...
    func activateConstraints(mainView: inout UIView, views: inout [UIView]) {
        ...
        let temperatureLabelConstraints = [
            views[0].topAnchor.constraint(equalTo: mainView.safeAreaLayoutGuide.topAnchor, constant: 50),
            views[0].heightAnchor.constraint(equalToConstant: 70),
            views[0].leftAnchor.constraint(equalTo: mainView.safeAreaLayoutGuide.leftAnchor),
            views[0].rightAnchor.constraint(equalTo: mainView.safeAreaLayoutGuide.rightAnchor)
        ]
        
        
        let windSpeedLabelConstraints = [
            views[1].topAnchor.constraint(equalTo: views[0].bottomAnchor, constant: 10),
            views[1].bottomAnchor.constraint(equalTo: views[1].topAnchor, constant: 30),
            views[1].leftAnchor.constraint(equalTo: mainView.leftAnchor),
            views[1].rightAnchor.constraint(equalTo: mainView.rightAnchor)
        ]
        
        
        
        NSLayoutConstraint.activate(temperatureLabelConstraints + windSpeedLabelConstraints)
    }
}
